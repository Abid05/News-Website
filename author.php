      ...
      <div class="container">
        <div class="row">
            ...
            <?php
                ...
                include "config.php";
                $recv_auth = $_GET["auth_id"];
                $sql1 = "SELECT * FROM user WHERE user_id = '$recv_auth'";
                $query1 = mysqli_query($con,$sql1);
                $row1 = mysqli_fetch_assoc($query1);
            ?>
              <h2 class="page-heading"><?php echo strtoupper($row1["username"]) ;  ?></h2>
                ...
                ?>
                    ...
                    <?php
                        ...
                        //pagination
                        $sql1 = "SELECT * FROM post  WHERE post.author={$recv_auth}";
                        $query1 = mysqli_query($con,$sql1);
                        ...
                        if(mysqli_num_rows($query1) > 0){
                            ...
                            if($page_num > 1){
                                echo '<li><a href="author.php?auth_id='.$recv_auth.'&page='.($page_num-1).'">Prev</a></li>';
                            }
                            ...
                            echo '<li class="'.$active.'"><a href="author.php?auth_id='.$recv_auth.'&page='. $i .'">'.$i.'</a></li>';
                            }
                            
                            if($total_pages > $page_num){
                                echo '<li><a href="author.php?auth_id='.$recv_auth.'&page='.($page_num+1).'">Next</a></li>';
                            }
                            echo "</ul>";
                        }
